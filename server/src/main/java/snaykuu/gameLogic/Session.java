...
import snaykuu.gameLogic.snaykuu.GameObjectType;
...
public class Session implements Game
{
	...
	private HashMap<String, snaykuu.gameLogic.snaykuu.GameObjectType> objects = new HashMap<String, snaykuu.gameLogic.snaykuu.GameObjectType>();
	...
	public snaykuu.gameLogic.snaykuu.Board getBoard()
	{
		return board;
	}
	 ...
	 */
	private snaykuu.gameLogic.snaykuu.Board createStandardBoard(int width, int height)
	{
		board = new Board(width, height);
		snaykuu.gameLogic.snaykuu.GameObjectType wall = objects.get("Wall");
	...
	{
		objects.put("Wall", new snaykuu.gameLogic.snaykuu.GameObjectType("Wall", true));
